...
public class SetPlayerVariableExpression implements IExpression, IAction {
    ...
    public SetPlayerVariableExpression(IExpression playerExpression, int variableName, IExpression valueExpression) {
